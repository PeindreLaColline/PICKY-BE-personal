...
public class ImageManager {
        ...
        return multipartFiles.stream()
                .map(file -> {
                    try {
                        ...
                        return extractFilePath(uploadImage(uploadFile));
                    } catch (IOException e) {
    ...
    private Optional<File> multipartFileToFile(MultipartFile multipartFile) throws IOException {
        ...
        File file = new File(s3Config.getFileDir()  + "image/" + storeFileName);
    ...
    private String uploadImage(File uploadFile) throws IOException {
