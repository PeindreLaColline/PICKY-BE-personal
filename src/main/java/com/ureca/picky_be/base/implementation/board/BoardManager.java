...
import com.ureca.picky_be.jpa.entity.board.BoardLike;
...
public class BoardManager {
    ...
    @Transactional(readOnly = true)
    public Slice<BoardCommentProjection> getTenBoardCommentsPerReq(Long userId, Long boardId, Long lastCommentId, Pageable pageable) {
        ...
        try {
            Slice<BoardCommentProjection> comments = boardRepository.getBoardComments(userId, boardId, lastCommentId, pageable);
            return comments;
        } catch(Exception e) {
